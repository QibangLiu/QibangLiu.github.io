...
Academic Positions
======
* **Research Scientist**, National Center for Supercomputing Applications (NCSA) @ University of Illinois Urbana-Champaign (UIUC), 2024 – Present
* **Adjunct Assistant Professor**, Department of Industrial & Manufacturing Systems Engineering @ Kansas State University (KSU), 2024 – Present
* **Postdoctoral Research Associate**, Beckman Institute for Advanced Science and Technology @ UIUC; Department of Aerospace Engineering @ UIUC; 2022 – 2024
...
<div style="display: flex; justify-content: space-between; align-items: center; width:100%; margin:auto;">
  <div style="text-align:center; width:40%;">
    <img src="/images/research/sdf_design/ondemand_design.png" style="width:100%;" alt="SDF-based Metamaterial Design">
    <p style="font-size:0.8em;">SDF-based Metamaterial Design using Diffusion Model</p>
  </div>
  <div style="text-align:center; width:60%;">
    <img src="/images/research/sdf_design/caseBe_Efig5.gif" style="width:100%;" alt="Neural Operator Transformer Forward Prediction">
...
<div style="display: flex; justify-content: space-between; align-items: center; width:100%; margin:auto;">
  <div style="text-align:center; width:35%;">
    <img src="/images/research/PD_FEM/diagPlateSY_FC2.gif" style="width:100%;" alt="Adaptive PD-FEM for Quasi-static Fracture Simulation">
    <p style="font-size:0.8em;">Adaptive PD-FEM for Quasi-static Fracture Simulation</p>
  </div>
  <div style="text-align:center; width:33%;">
    <img src="/images/research/PD_FEM/xpd_test.gif" style="width:100%;" alt="XOSBPD for Dynamic Uniaxial Tension Fracture">
    <p style="font-size:0.8em;">XOSBPD for Dynamic Uniaxial Tension Fracture</p>
  </div>
  <div style="text-align:center; width:24%;">
    <img src="/images/research/PD_FEM/xpd.gif" style="width:100%;" alt="XOSBPD for Dynamic Kalthoff–Winkler Experiment">
    <p style="font-size:0.8em;">XOSBPD for Dynamic Kalthoff–Winkler Experiment</p>
  </div>
</div>
...
<div style="display: flex; justify-content: space-between; align-items: center; width:80%; margin:auto;">
  <div style="text-align:center; width:50%;">
    <img src="/images/research/DFCA/fabric_mesh.png" style="width:100%;" alt="Fabric Meshing for Textile Composites">
    <p style="font-size:0.8em;">Fabric Meshing for Textile Composites</p>
  </div>
  <div style="text-align:center; width:40%;">
    <img src="/images/research/DFCA/DFCA.png" style="width:100%;" alt="Digital Fabric and Composite Analyzer (DFCA)">
